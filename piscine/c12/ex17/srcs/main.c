...
{	
	...
	ft_sorted_list_insert(&list2, "16", ft_strcmp_data);
	ft_sorted_list_insert(&list2, "9", ft_strcmp_data);
	ft_sorted_list_insert(&list2, "18", ft_strcmp_data);
	ft_sorted_list_insert(&list2, "126", ft_strcmp_data);
	ft_sorted_list_insert(&list2, "1", ft_strcmp_data);
	ft_sorted_list_insert(&list2, "4", ft_strcmp_data);
	
	ft_sorted_list_merge(&list, list2, ft_strcmp_data);
	ft_print_list(list);
	return (0);
}
